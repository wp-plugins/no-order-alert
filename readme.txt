...
Plugin is used to get no order alert as email to your administrator email or any other added email accounts by regular invervals.
...
Yes, this version of the plugin is supported and tested upto WooCommerce 2.2. We are ready to give you regulare updates on regular WooCommerce update.
...
2. Easy to use.
3. Clean code.
4. User can design its own email template by using template edior.
5. Regular updates.
